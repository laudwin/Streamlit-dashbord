...
import pandas as pd
from openai import AzureOpenAI  # ✅ Correct new client

# --- Azure OpenAI Config
client = AzureOpenAI(
    api_key="db4c85906b5047419a733719992b649e",  # 🔁 Replace with your key
    azure_endpoint="https://tisl-openaiservice.openai.azure.com",  # 🔁 Replace with your Azure endpoint (no /openai/ path)
    api_version="2025-01-01-preview"  # ✅ Use your actual API version
)
...
st.markdown(
    """
    <div class="footer">
        <p>Powered by TISL WIC | <a href="#" target="_blank"></a></p>
    </div>
    """,
